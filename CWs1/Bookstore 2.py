...
class book:
    ...
    def report_book(self):
        print
        self.bno, self.bname, self.auname
...
class student:
    ...
    def reportstud(self):
        print
        self.admno, self.name, self.token
                    ...
                    try:
                        while True:
                            ...
                            if bk.ret_bno() == bn:
                                ...
                                print
                                "\t \t and submit within 15 days"
                                print
                                print
                                "\t \t Fine Rs.20 for each day after 15 days period..!!"
                                print
    ...
    try:
        while True:
            ...
            if st.ret_admno() == sn:
                ...
                print
                print
                "\t Student Token Number", st.ret_token()
                if st.ret_token() == 1:
                    try:
                        while True:
                            bk = load(fin2)
